...
<body>
	<form id="login">
		...
		<fieldset id="inputs">
			...
			<input id="name" type="text" placeholder="用户名" autofocus> <input
				id="pwd" type="password" placeholder="密码">
		...
		<fieldset id="actions">
			...
			</select> <input type="button" id="submit" value="登录" onclick="sub()">
